...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            frontend_ready,
            commands::llm::generate_storyboard_prompts,
            commands::llm::chat_completion,
            commands::llm::read_text_file,
            image::split_image,
            ...
            image::save_source_to_directory,
            ...
            ai_commands::test_kling_connection,
            ai_commands::submit_video_batch,
            ai_commands::cancel_video_batch,
