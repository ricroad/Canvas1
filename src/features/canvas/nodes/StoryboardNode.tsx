...
import { openFileDialog, openPath, revealItemInDir } from '@/commands/web/dialog';
...
const STORYBOARD_NODE_WIDTH_PX = 420;
const STORYBOARD_NODE_MIN_HEIGHT_PX = 400;
  ...
  const handlePackSingleImages = useCallback(async () => {
    ...
    try {
      ...
      if (isTauriEnv()) {
        ...
        outputDir = await join(rootDir, normalizedProjectName);
      } else {
        outputDir = `${rootDir}/${normalizedProjectName}`;
      }
